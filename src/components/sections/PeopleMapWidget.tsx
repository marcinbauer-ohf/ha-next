...
export default function PeopleMapWidget() {
  ...
  return (
    <div className="relative h-48 lg:h-56 rounded-ha-xl overflow-hidden border border-surface-lower bg-surface-default">
      ...
      <div className="absolute top-ha-3 left-ha-3 z-[500] flex items-center gap-ha-2 rounded-ha-pill bg-surface-default/85 border border-white/10 px-ha-3 py-1.5 pointer-events-none">
